...
namespace Gravityzero.Console.Utility.Commands
{
    public class GetRolesCommand : ICommand
    {
        ...
        public CommandResult Execute(ConsoleContext context)
        {
            ...
            var result = WinApiConnector.RequestGet<String, Response<IEnumerable<Role>>>($"{context.ConsoleSettings.ServerAddress}:{context.ConsoleSettings.Port}/Api/Configuration/GetAllRoles","");
